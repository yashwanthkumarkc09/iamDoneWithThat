...
package exportPPModule.exportPPFeature;
import pom.exportPage;
import java.io.File;
...
public class exportPPScript extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterData(new exportPage(driver).userName,"balakrishna@opaltechsolutions.com");
        ...
        try
        {
            actions.EnterData(new exportPage(driver).userPassword,"Opal@1234");
